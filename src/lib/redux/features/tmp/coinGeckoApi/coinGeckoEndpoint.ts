import { coinGeckoApi as api } from '@/lib/redux/features/tmp/coinGeckoApi/coinGeckoApi';
const injectedRtkApi = api.injectEndpoints({
  endpoints: (build) => ({
    ...
    >({
      query: (queryArg) => ({
        url: `/indexes/${queryArg.marketId}/${queryArg.id}`,
      }),
    }),
    getIndexesList: build.query<
      GetIndexesListApiResponse,
      GetIndexesListApiArg
    >({
...
export const {
  ...
  useLazyGetSimplePriceQuery,
  useGetSimpleTokenPriceByIdQuery,
  useLazyGetSimpleTokenPriceByIdQuery,
  useGetSimpleSupportedVsCurrenciesQuery,
  useLazyGetSimpleSupportedVsCurrenciesQuery,
  useGetCoinsListQuery,
  useLazyGetCoinsListQuery,
  useGetCoinsMarketsQuery,
  useLazyGetCoinsMarketsQuery,
  useGetCoinsByIdQuery,
  useLazyGetCoinsByIdQuery,
  useGetCoinsByIdTickersQuery,
  useLazyGetCoinsByIdTickersQuery,
  useGetCoinsByIdHistoryQuery,
  useLazyGetCoinsByIdHistoryQuery,
  useGetCoinsByIdMarketChartQuery,
  useLazyGetCoinsByIdMarketChartQuery,
  useGetCoinsByIdMarketChartRangeQuery,
  useLazyGetCoinsByIdMarketChartRangeQuery,
  useGetCoinsByIdContractAndContractAddressQuery,
  useLazyGetCoinsByIdContractAndContractAddressQuery,
  useGetCoinsByIdContractAndContractAddressMarketChartQuery,
  useLazyGetCoinsByIdContractAndContractAddressMarketChartQuery,
  useGetCoinsByIdContractAndContractAddressMarketChartRangeQuery,
  useLazyGetCoinsByIdContractAndContractAddressMarketChartRangeQuery,
  useGetCoinsByIdOhlcQuery,
  useLazyGetCoinsByIdOhlcQuery,
  useGetAssetPlatformsQuery,
  useLazyGetAssetPlatformsQuery,
  useGetCoinsCategoriesListQuery,
  useLazyGetCoinsCategoriesListQuery,
  useGetCoinsCategoriesQuery,
  useLazyGetCoinsCategoriesQuery,
  useGetExchangesQuery,
  useLazyGetExchangesQuery,
  useGetExchangesListQuery,
  useLazyGetExchangesListQuery,
  useGetExchangesByIdQuery,
  useLazyGetExchangesByIdQuery,
  useGetExchangesByIdTickersQuery,
  useLazyGetExchangesByIdTickersQuery,
  useGetIndexesQuery,
  useLazyGetIndexesQuery,
  useGetIndexesByMarketIdAndIdQuery,
  useLazyGetIndexesByMarketIdAndIdQuery,
  useGetIndexesListQuery,
  useLazyGetIndexesListQuery,
  useGetDerivativesQuery,
  useLazyGetDerivativesQuery,
  useGetDerivativesExchangesQuery,
  useLazyGetDerivativesExchangesQuery,
  useGetDerivativesExchangesByIdQuery,
  useLazyGetDerivativesExchangesByIdQuery,
  useGetDerivativesExchangesListQuery,
  useLazyGetDerivativesExchangesListQuery,
  useGetExchangesByIdVolumeChartQuery,
  useLazyGetExchangesByIdVolumeChartQuery,
  useGetNftsListQuery,
  useLazyGetNftsListQuery,
  useGetNftsByIdQuery,
  useLazyGetNftsByIdQuery,
  useGetNftsByAssetPlatformIdContractAndContractAddressQuery,
  useLazyGetNftsByAssetPlatformIdContractAndContractAddressQuery,
  useGetExchangeRatesQuery,
  useLazyGetExchangeRatesQuery,
  useGetSearchQuery,
  useLazyGetSearchQuery,
  useGetSearchTrendingQuery,
  useLazyGetSearchTrendingQuery,
  useGetGlobalQuery,
  useLazyGetGlobalQuery,
  useGetGlobalDecentralizedFinanceDefiQuery,
  useLazyGetGlobalDecentralizedFinanceDefiQuery,
} = injectedRtkApi;
